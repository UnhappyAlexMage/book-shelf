...
let menuItems: ATypesNav[] = [
    { id: 1, current: "Все книги", label: "Все книги", icon: PiBooksBold, uniqueColorText: 'text-sky-600', uniqueColorBG: 'bg-sky-600', bookStatus: 'Все книги'},
    { id: 2, current: "Чтение", label: "Чтение", icon: FaReadme, uniqueColorText: 'text-sky-600', uniqueColorBG: 'bg-teal-500', bookStatus: 'Чтение'},
    { id: 3, current: "Прочитанные", label: "Прочитанные", icon: AiOutlineFileDone, uniqueColorText: 'text-sky-600', uniqueColorBG: 'bg-lime-500', bookStatus: 'Прочитанные'},
    { id: 4, current: "Фавориты", label: "Фавориты", icon: MdRecommend, uniqueColorText: 'text-sky-600', uniqueColorBG: 'bg-purple-500', bookStatus: 'Фавориты' },
    { id: 5, current: "Ваши записи", label: "Ваши записи", icon: AiOutlineUserSwitch, uniqueColorText: 'text-yellow-600', uniqueColorBG: 'bg-green-500', padding: 'mt-8'},
    { id: 6, current: "Карта", label: "Карта", icon: LuMapPinCheck, uniqueColorText: 'text-green-700', uniqueColorBG: 'bg-green-500'},
    { id: 7, current: "О проекте", label: "О проекте", icon: AiOutlineExclamationCircle, uniqueColorText: 'text-red-500', uniqueColorBG: 'bg-gray-600',},
];
                    ...
                    <React.Fragment key={menuItem.id}>
                        ...
                        >
                            <div className="flex items-center ml-4 p-1">
                                <menuItem.icon
                                    className={`text-3xl text-gray-400 ${ isCorrect === menuItem.current ? menuItem.uniqueColorText : "" }`}
                                />
                                <span
